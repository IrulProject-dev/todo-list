...
<div
    ...
    <div class="flex-col flex  self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
        <div class="self-start hidden lg:flex flex-col  text-gray-300">
            ...
            <p class="pr-3 text-sm opacity-75">Welcome back! Please sign in to access your account and continue managing your tasks efficiently.</p>
        </div>
    </div>
    <div class="flex justify-center self-center  z-10">
            ...
            @csrf
                ...
                <div class="space-y-6">
                    <div class="">
                        <input name="email" id="email" type="email" class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" type="" placeholder="Email">
                    </div>
                    <div class="relative" x-data="{ show: true }">
						<input placeholder="Password" :type="show ? 'password' : 'text'" name="password" id="password" class="text-sm text-gray-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
                ...
                <div class="mt-7 text-center text-gray-300 text-xs">
                    <span>
                        GitHub ©
                        <a href="https://github.com/IrulProject-dev" rel="" target="_blank" title="IrulProject" class="text-purple-500 hover:text-purple-600 ">IrulesDev</a></span>
                </div>
            </div>
    </div>
</div>
...
<footer class="bg-transparent absolute w-full bottom-0 left-0 z-30">
    <div class="container p-5 mx-auto  flex items-center justify-between ">
        <div class="flex mr-auto">
            <a href="https://github.com/IrulProject-dev" target="_blank" title="IrulProject-dev" class="text-center text-gray-700 focus:outline-none"><i class="fas fa-tasks text-xl"></i>
